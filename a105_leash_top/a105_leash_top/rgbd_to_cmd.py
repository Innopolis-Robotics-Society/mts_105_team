...
class WhiteRoadNode(Node):
    def __init__(self):
        ...
        self.declare_parameters("", [
            ...
            ("w_gain", 3.2), ("w_max", 2.5),
            ("Ld_min", 0.25), ("Ld_alpha_k", 2.4), ("v_alpha_k", 2.4),
            ("tgt_depth_gain", 1.25),
            ...
            ("dead_reach_px", 70),          # минимальная достигнутая «глубина» центролинии в пикселях
            ("dead_use_guard_void", True),  # учитывать guard_void в критерии тупика
            ("dead_turn_w", 1.0),           # рад/с, положительный = влево
        ])
